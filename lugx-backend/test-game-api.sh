...
BASE_URL="https://lugx.yourdomain.com"
...
# 7. PUT /games/123
run_test "PUT /games/123" \
    "curl -X PUT \"$BASE_URL/games/123\" -H \"Authorization: Bearer $AUTH_TOKEN\" -H \"Content-Type: application/json\" -d '$UPDATE_GAME'"

# 8. DELETE /games/123
run_test "DELETE /games/123" \
